        ...
        <div class="bg-gray-800/30 rounded-xl p-6">
            <div class="flex justify-between items-start mb-3">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h4 class="font-semibold text-violet-400 flex items-center">
                            {{ $comment->author }}
                            @if($comment->user && $comment->user->isModerator())
                                <span class="ml-2 px-2 py-0.5 bg-violet-600/20 text-violet-400 rounded text-xs font-semibold">Модератор</span>
                            @endif
                        </h4>
                ...
                <!-- Кнопки управления комментарием (только для автора или модератора) -->
                @auth
